...
extern "C" {
	...
	/// \return 1 if there were no errors, or PROS_ERR if an error occured
	///         taking or returning the screen mutex.
	pub fn screen_copy_area(x0: i16, y0: i16, x1: i16, y1: i16, buf: *const u32, stride: i32) -> u32;
	...
	/// \return 1 if there were no errors, or PROS_ERR if an error occured
	///          taking or returning the screen mutex.
	pub fn screen_print(txt_fmt: text_format_e_t, line: i16, text: *const core::ffi::c_char, ...) -> u32;
	...
	///  \return 1 if there were no errors, or PROS_ERR if an error occured
	///          taking or returning the screen mutex.
	pub fn screen_print_at(txt_fmt: text_format_e_t, x: i16, y: i16, text: *const core::ffi::c_char, ...) -> u32;
	...
	pub fn screen_vprintf(txt_fmt: text_format_e_t, line: i16, text: *const core::ffi::c_char, ...) -> u32;
