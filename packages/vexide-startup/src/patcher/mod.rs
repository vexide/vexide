...
pub(crate) unsafe fn patch() {
    ...
    unsafe {
        ...
        //   intentionally trigger this check in order to break the patcher ouf of an infinite
        //   loop).
        ...
        // This is a 2mb slice of uninitialized memory that we've reserved for building the new
        // binary in.
